defmodule Alixir.OSS.PresignedURL do
  ...
  def presigned_url(http_method, %FileObject{} = file_object, options \\ [])
      when http_method in @valid_http_methods do
    content_type =
    ...
    %URI{
      ...
      query:
        http_method
        |> presigned_url_parameters(signature, expires, callback)
        |> URI.encode_query()
    }
    |> URI.to_string()
  end
